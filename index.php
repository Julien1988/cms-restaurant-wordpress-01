...
<main class="main main-front-page">
    ...
    <section class="main-front-page__section main-front-page__section-top">
        <div class="main-front-page__section-top__container">
            <img class="main-front-page__section-top__image" src="assets/svg/fastest-delivery.svg" alt="" />
        ...
        <div class="main-front-page__section-top__container">
            <img class="main-front-page__section-top__image" src="assets/svg/quality-food.svg" alt="" />
        ...
        <div class="main-front-page__section-top__container">
            <img class="main-front-page__section-top__image" src="assets/svg/original-recipes.svg" alt="" />
    ...
    <section class="main-front-page__section main-front-page__section-02">
        <img src="assets/images/the-chef.jpg" alt="" class="main-front-page__section-02__image" />
